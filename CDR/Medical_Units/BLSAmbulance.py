...
class BLSAmbulance(MedicalUnit):
    ...
    def __init__(self, medical_unit_id, location_lat, location_long, speed, creation_time):
        ...
        self.number_of_urgent = 0
        self.number_of_medium = 0
        self.number_of_non_urgent = 3
...
new_amb = BLSAmbulance(medical_unit_id=1, location_lat=2, location_long=5, speed=50, creation_time=0)
