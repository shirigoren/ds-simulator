from shiri.DiaryEvent import *
# from DiaryEvents.DiaryEvent import *
from DisasterSite import *
...
class simulation(object):
    ...
    def new_ds(self, event):
        ...
        self.disaster_sites.append(event.disaster_site)
        allocations = allocation_solver()
    ...
    def medical_unit_arrived_to_ds(self, event):
        ...
        medical_unit.medical_unit_arrived_to_site()
    ...
    def allocation_solver(self):
        ...
        #todo - Call the algorithm to get allocations

        return 0

new_simulation = simulation(simulation_number=1, time_start=8, time_end=10)